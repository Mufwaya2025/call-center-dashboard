...
const fieldLabels: { [key: string]: string } = {
  ...
  callerNumber: 'Caller Number (Agent ID)',
  calleeNumber: 'Callee Number (Client)',
  context: 'Context',
  callerId: 'Caller ID',
  ...
  endTime: 'End Time',
  callTime: 'Call Time (seconds)',
  talkTime: 'Talk Time (seconds)',
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Upload a sample of your CSV file to see how the mapping will work with your data.
              </p>
            </div>
          </div>
          ...
          <div className="bg-muted p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                {Object.keys(mapping).length} / {Object.keys(fieldLabels).length}
              </div>
            </div>
